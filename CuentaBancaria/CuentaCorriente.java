...
public class CuentaCorriente extends Cuenta {
    ...
    float sobregiro;
    /*Constructor de la clase CuentaCorrienta @param saldo Parámetro 
    que define el saldo de la cuenta corriente @param tasa Parámetro 
    que define la tasa anual de interés de la cuenta corriente*/
...
saldo de la cuenta @param cantidad Parámetro que define la cantidad 
de dinero a retirar de la cuenta corriente*/
...
el saldo de la cuenta @param cantidad Parámetro que define la cantidad 
de dinero a consignar en la cuenta corriente*/
