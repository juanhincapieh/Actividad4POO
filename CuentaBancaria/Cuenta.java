...
public class Cuenta {
    ...
    saldo de la cuenta @param saldo Parámetro que define la cantidad de 
    dinero a retirar de la cuenta*/
    ...
    public void retirar(float cantidad) {
        ...
        if (nuevoSaldo > 0) {
            ...
            if (nuevoSaldo < 0) {
                ...
                JOptionPane.showMessageDialog(null, "La cantida a retirar excede el saldo actual.");
            }
