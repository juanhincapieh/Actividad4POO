...
public class CuentaAhorros extends Cuenta {
    ...
    /*Constructor de la clase CuentaAhorros @param saldo Parámetro que 
    define el saldo de la cuenta de ahorros @param tasa Parámetro que 
    define la tasa anual de interés de la cuenta de ahorros*/
...
saldo de la cuenta @param saldo Parámetro que define la cantidad a 
...
el saldo de la cuenta @param saldo Parámetro que define la cantidad a 
consignar en una cuenta de ahorros*/
    ...
    public void imprimir() {
        JOptionPane.showMessageDialog(null, "Saldo = $"+saldo+
                                          ...
                                          "\nNúmero de transacciones = #"+(númeroConsignaciones + númeroRetiros));
    }
}