...
* @param área Parámetro que define el área de un inmueble para la vivienda
...
* que tiene un inmueble para la vivienda*/
    ...
    void imprimir() {
        ...
        JOptionPane.showMessageDialog(null, "Número de habitaciones = " + númeroHabitaciones+
                                          "\nNúmero de baños = " + númeroBaños);
    }
}
