...
* en conjunto cerrado tiene o no campos deportivos*/
    public CasaConjuntoCerrado(int identificadorInmobiliario, int área, String dirección, int númeroHabitaciones, int númeroBaños,
        int númeroPisos, int valorAdministración, boolean tienePiscina, boolean tieneCamposDeportivos) {
...
//Método que muestra en pantalla los datos de una casa en conjunto cerrado
    ...
    void imprimir() {
        ...
        JOptionPane.showMessageDialog(null, "Valor de la administración = " + valorAdministración +
                                          "\nPiscina = " + tienePiscina +
                                          "\ncampos deportivos = " + tieneCamposDeportivos);
    }
}
