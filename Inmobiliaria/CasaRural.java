...
/* Esta clase denominada CasaRural modela un tipo específico de casa ubicada en el sector rural*/
...
public class CasaRural extends Casa {
    ...
    // Atributo que identifica la altitud a la que se encuentra una casa rural protected int altitud;
...
//Método que muestra en pantalla los datos de una casa rural
    ...
    void imprimir(String altitud) {
        super.imprimir(); // Invoca al método imprimir de la clase padre
        JOptionPane.showMessageDialog(null, "Distancia la cabecera municipal = " + númeroHabitaciones + "km" +
                                          "\nAltitud sobre ell nivel del mar = " + altitud + "metros");
    }
}